<template>
  <div class="mx-auto mt-20 w-full max-w-max px-4 text-center">
    ...
    >
      <h2 class="mb-5 text-2xl font-bold capitalize md:mb-10">laptops</h2>
      <ul
      ...
      >
        <li
          ...
          :key="product.id"
          class="card flex flex-col items-center bg-white py-4 px-2 shadow-3xl md:py-5 md:px-5"
        >
...
const getProductData = computed(() => {
  axios.get(storeData.baseUrl + "/category/laptops").then((res) => {
